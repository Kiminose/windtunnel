...
from read_h5 import *
from create_sqlite_1table import *
...
def put_file_in_bdd(fichier_h5_force,fichier_h5_pressure, curseur):
    name_force = str(fichier_h5_force)
    fichier_force = read_h5(fichier_h5_force)
    name_pressure = str(fichier_h5_pressure)
    fichier_pressure = read_h5(fichier_h5_pressure)



    convert_h5force_dataframe(fichier_force)
    code_confog_maquette(fichier_force)
    convert_h5pressure_dataframe(fichier_pressure)
